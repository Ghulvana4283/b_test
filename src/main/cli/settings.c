...
#endif
    { "acc_collision_threshold",    VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, UINT16_MAX }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, collision_threshold) },
